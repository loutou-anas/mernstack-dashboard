...
const CompositionSpecifique = () => {
    ...
    const labels = {
        pageTitle: language === 'en' ? 'Specific Composition - Mediterranean' : 'Composition Spécifique - Méditerranée',
        selectMonth: language === 'en' ? 'Select Month:' : 'Sélectionnez le mois:',
        selectYear: language === 'en' ? 'Select Year:' : 'Sélectionnez l\'année:',
        chartTitle: language === 'en' ? 'Specific Composition of Total Catches' : 'Composition spécifique des captures Totales',
        loading: language === 'en' ? 'Loading...' : 'Chargement...',
        description: language === 'en' ? 'The specific composition of catches indicates the proportions of different species in total catches.' : 'La composition spécifique des captures indique les proportions des différentes espèces dans les captures totales.',
    };
    ...
    useEffect(() => {
        if (selectedMonth && selectedYear) {
            const fetchData = async () => {
                try {
                    const response = await get('/api/dashboard/composition', { month: selectedMonth, year: selectedYear });
...
export default CompositionSpecifique;
