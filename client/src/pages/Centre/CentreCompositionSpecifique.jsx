...
const CentreCompositionSpecifique = () => {
    ...
    const labels = {
        pageTitle: language === 'en' ? 'Specific Composition - Central Atlantic' : 'Composition Spécifique - Atlantique Centre',
    ...
    useEffect(() => {
        if (selectedMonth && selectedYear) {
            const fetchData = async () => {
                try {
                    const response = await get('/api/atlantique-centre/composition', { month: selectedMonth, year: selectedYear });
...
export default CentreCompositionSpecifique;
