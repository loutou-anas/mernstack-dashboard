...
const CentreImportData = () => {
    ...
    const labels = {
        pageTitle: language === 'en' ? 'Import File - Central Atlantic' : 'Importer Fichier - Atlantique Centre',
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await post('/api/atlantique-centre/upload', formData, {
                headers: {
...
export default CentreImportData;
