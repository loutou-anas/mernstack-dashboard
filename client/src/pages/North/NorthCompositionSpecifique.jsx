...
const NorthCompositionSpecifique = () => {
    ...
    const labels = {
        pageTitle: language === 'en' ? 'Specific Composition - North Atlantic' : 'Composition Spécifique - Atlantique Nord',
    ...
    useEffect(() => {
        if (selectedMonth && selectedYear) {
            const fetchData = async () => {
                try {
                    const response = await get('/api/atlantique-North/composition', { month: selectedMonth, year: selectedYear });
...
export default NorthCompositionSpecifique;
