...
const SudResultatParEspece = () => {
    ...
    const labels = {
        pageTitle: language === 'en' ? 'Results by Species - South Atlantic' : 'Résultat par Espèce - Atlantique Sud',
        ...
        sizeStructureTitle: language === 'en' ? 'Size Structure of' : 'Structure des tailles de la',
        densityDistributionTitle: language === 'en' ? 'Density Distribution' : 'Distribution des densités',
        maturityStagesTitle: language === 'en' ? 'Maturity Stages of' : 'Stades de Maturité de la',
    ...
    useEffect(() => {
        const fetchSpeciesOptions = async () => {
            if (selectedMonth && selectedYear) {
                try {
                    const response = await get('/api/atlantique-sud/species-by-month-year', { month: selectedMonth, year: selectedYear });
    ...
    useEffect(() => {
        if (selectedSpecies && selectedMonth && selectedYear) {
            const fetchData = async () => {
                try {
                    const response = await get('/api/atlantique-sud/species-result', { species: selectedSpecies, month: selectedMonth, year: selectedYear });
    ...
    useEffect(() => {
        if (selectedSpecies && selectedMonth && selectedYear) {
            const fetchMaturityData = async () => {
                try {
                    const response = await get(`/api/atlantique-sud/maturity-data`, { species: selectedSpecies, month: selectedMonth, year: selectedYear });
...
export default SudResultatParEspece;
